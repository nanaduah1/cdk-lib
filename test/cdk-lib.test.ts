...
import { PoetryDependenciesParser } from "../lib/lambda/bundling";
...
test("PoetryDependenciesParser", () => {
  const parser = new PoetryDependenciesParser();
  const localDeps = parser.getLocalDependencies(exampleLockFile);
